...
public class Grenader4 : MonoBehaviour
{
    ...
    public void Move()
    {
        ...
        transform.Translate(new Vector3(Input.GetAxis("Horizontal4") * 10 * Time.deltaTime, Input.GetAxis("Vertical4") * 10 * Time.deltaTime, 0), Space.World);
    }

    private void CheckFire()
    {
        if (Input.GetKeyDown("joystick 4 button 0") && !fire)
        {
            fire = true;
